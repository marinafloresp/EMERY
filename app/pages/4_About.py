...
st.write("The EMERY app has been developed by Marina Flores Payan as the final project for the MSc in Bioinformatics at the University of Glasgow (2022-2023).")
...
st.write("The back-end computations and the interpretable Machine Learning models have been developed using several Python's libraries: [shap](%s), [scikit-learn](%s), [lime](%s), [altair](%s), etc." %(shap, scikit,lime, altair))
