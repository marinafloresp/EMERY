        ...
        if len(subgroup) > 1:
            ...
            with tab4:
                ...
                if option == "Samples in interaction vs rest of samples":
                    ...
                    st.write(
                        "DEA performed with the samples in the selected disease*cluster interaction vs all other samples.")
                    if size > 2:
                    ...
                    st.write(
                        "DEA has been performed within samples in the selected interaction and comparing Resistant vs Non-resistant samples.")
                    if size > 3:
